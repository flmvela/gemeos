-- ============================================================
-- CORE MIGRATION - ESSENTIAL TABLES FOR TENANT SYSTEM (FINAL VERSION)
-- ============================================================
-- Apply this in Supabase SQL Editor - Handles all conflicts

-- Enable necessary extensions
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";
CREATE EXTENSION IF NOT EXISTS "pg_trgm";

-- Helper function for timestamps (safe creation)
...
-- Safe trigger creation for roles
DO $$
BEGIN
...
-- ============================================================
-- 2. USER PROFILES TABLE - Skip trigger creation since it exists
-- ============================================================
-- Profiles table and trigger already exist, skip
...
-- Safe trigger creation for user_tenants
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_user_tenants_updated_at') THEN
...
-- Safe trigger creation for invitations
DO $$
BEGIN
...
-- Safe trigger creation for tenant_domains
DO $$
BEGIN
...
-- ============================================================
-- 7. DROP AND RECREATE HELPER FUNCTIONS
-- ============================================================
-- Drop existing functions first
DROP FUNCTION IF EXISTS public.user_has_role_in_tenant(UUID, UUID, VARCHAR);
DROP FUNCTION IF EXISTS public.get_user_role_in_tenant(UUID, UUID);
