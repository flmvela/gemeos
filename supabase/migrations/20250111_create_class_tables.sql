...
CREATE TABLE IF NOT EXISTS public.class_student_invitations (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  class_id UUID NOT NULL REFERENCES public.classes(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS public.class_difficulty_levels (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  class_id UUID NOT NULL REFERENCES public.classes(id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS idx_classes_domain ON public.classes(domain_id);
CREATE INDEX IF NOT EXISTS idx_classes_status ON public.classes(status);
CREATE INDEX IF NOT EXISTS idx_classes_enrollment_code ON public.classes(enrollment_code);
...
CREATE INDEX IF NOT EXISTS idx_class_invitations_class ON public.class_student_invitations(class_id);
CREATE INDEX IF NOT EXISTS idx_class_invitations_email ON public.class_student_invitations(student_email);
CREATE INDEX IF NOT EXISTS idx_class_invitations_status ON public.class_student_invitations(invitation_status);

CREATE INDEX IF NOT EXISTS idx_class_difficulty_class ON public.class_difficulty_levels(class_id);
