...
If you didn''t expect this invitation, please ignore this email.',
  '{
    "type": "object",
    "properties": {
      "invite_link": {"type": "string", "description": "The invitation acceptance link"},
      "tenant_name": {"type": "string", "description": "The name of the tenant"},
      "tenant_slug": {"type": "string", "description": "The URL slug of the tenant"},
      "tenant_id": {"type": "string", "description": "The UUID of the tenant"},
      "inviter_name": {"type": "string", "description": "The name of the person sending the invitation"},
      "expires_at": {"type": "string", "description": "When the invitation expires"},
      "support_email": {"type": "string", "description": "Support contact email"},
      "login_url": {"type": "string", "description": "URL to sign in"}
    },
    "required": ["invite_link", "tenant_name", "tenant_slug", "inviter_name", "expires_at"]
  }',
  true,
  true,
  NULL
