-- ============================================================
-- RBAC Functions - Phase 1 (SAFE INSTALL)
-- Keep existing auth_is_platform_admin, add new RBAC functions
-- ============================================================

-- ============================================================
-- CLEANUP: Drop only new RBAC functions (keep existing auth functions)
-- ============================================================

DROP FUNCTION IF EXISTS public.check_permission(uuid, text, text);
DROP FUNCTION IF EXISTS public.check_permission(text, text, uuid);
DROP FUNCTION IF EXISTS public.check_permissions_batch(jsonb, uuid);
DROP FUNCTION IF EXISTS public.get_user_permissions(uuid);
DROP FUNCTION IF EXISTS public.grant_permission(text, text, text[]);
DROP FUNCTION IF EXISTS public.revoke_permission(text, text);

-- Drop view if exists
DROP VIEW IF EXISTS public.permission_details;
...
-- ============================================================
-- 5. PERMISSION DETAILS VIEW
-- For admin UI and reporting
-- ============================================================
...
SELECT 'RBAC Functions - Safe Installation Complete! 🎉' as status,
       'Using existing auth_is_platform_admin function' as note;

-- Test the main function
SELECT 'Testing check_permission function...' as test_step,
       public.check_permission('page:admin_dashboard', 'read') as test_result;