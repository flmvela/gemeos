-- ============================================================
-- RBAC Functions - Phase 1 (CLEAN INSTALL)
-- Drop existing functions and create fresh ones
-- ============================================================
...
DROP FUNCTION IF EXISTS public.auth_is_platform_admin();

-- Drop view if exists
DROP VIEW IF EXISTS public.permission_details;

-- ============================================================
-- 1. HELPER FUNCTIONS (Create these first as others depend on them)
-- ============================================================
...
-- ============================================================
-- 2. MAIN PERMISSION CHECK FUNCTION
...
SELECT 'RBAC Functions - Clean Installation Complete! 🎉' as status,
