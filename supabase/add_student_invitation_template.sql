-- Step 1: Add student_invitation to the email_template_type enum
-- This adds the new value to the enum type if it doesn't already exist
ALTER TYPE email_template_type ADD VALUE IF NOT EXISTS 'student_invitation';

-- Step 2: Insert the student invitation email template
-- This creates the template that will be used for student invitations
...
WHERE template_type = 'student_invitation';